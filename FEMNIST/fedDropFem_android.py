...
class FedDropFemAndroid(Strategy):
    ...
    def configure_fit(
        ...
        for client in clients:
            ...
            if (client.cid in self.straggler) and rnd > 2:
                ...
                fit_ins_drop = FitIns(self.drop_dynamic(parameters, self.p_val, [0, 4], 2, client.cid), config_drop)
    ...
    def aggregate_fit(
        ...
        # Total training round for FEMNSIT set to 250, hence start upating threshold at 250/2
        ...
        weights = self.aggregate_drop(weights_results, self.droppedWeights, self.weight_shapes, self.droppedWeightsShape)
    ...
    def find_min(self, parameters: Parameters, results: List[Tuple[Weights, int]], idxList: List[int], rnd: int):
        ...
        for idx in idxList:
            ...
            if (idx == 0 and rnd == 3):
                self.changeThreshold = (self.changeThreshold + sum[noChangeIdx[0]]) / 2
                print("threshold for ", idx, "updated to: ", self.changeThreshold)
