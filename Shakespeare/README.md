...
This project demonstrates a invariant Dropout setup with Android Clients with the Shakespeare dataset.
The Shakespeare dataset is publicly available form the benchmarking framework [LEAF](https://github.com/TalwalkarLab/leaf)
...
## Sample Data and Model definition
  - Inside `Shakespeare/client/app/src/main/assets/data` contains 5 sample Shakespeare user dataset that can be used for training. 
...
3. Use the `split_json_data.py` in this directory to general single user test and training datasets
    ```shell
